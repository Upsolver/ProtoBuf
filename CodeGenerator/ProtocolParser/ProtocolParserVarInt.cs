...
namespace SilentOrbit.ProtocolBuffers
{
    public static partial class ProtocolParser
    {
        ...
        /// Reads past a varint for an unknown field.
        /// </summary>
        public static void ReadSkipVarInt(byte[] buffer, ref int offset)
        {
            while (true)
            {
        ...
        public static byte[] ReadVarIntBytes(byte[] buffer, ref int offset)
        {
            int start = offset;
            while (true)
            {
            ...
            byte[] ret = new byte[offset - start];
            Array.Copy(buffer, start, ret, 0, ret.Length);
            return ret;
        }
        ...
        {
            return (int)ReadUInt64(buffer, ref offset);
        }
        ...
        /// Zig-zag signed VarInt format
        /// </summary>
        public static int ReadZInt32(byte[] buffer, ref int offset)
        {
            uint val = ReadUInt32(buffer, ref offset);
            return (int)(val >> 1) ^ ((int)(val << 31) >> 31);
        }
        ...
        /// The same functionality can be achieved using: (long)ReadUInt64(stream);
        /// </summary>
        public static int ReadInt64(byte[] buffer, ref int offset)
        {
            return (int)ReadUInt64(buffer, ref offset);
        }
        ...
        /// Zig-zag signed VarInt format
        /// </summary>
        public static long ReadZInt64(byte[] buffer, ref int offset)
        {
            ulong val = ReadUInt64(buffer, ref offset);
            return (long)(val >> 1) ^ ((long)(val << 63) >> 63);
        }
